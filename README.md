...
<body id="top">
  ...
  <header style="background-color: rgb(185, 164, 181);>
    <div class="container">

      <a href="#">
        <h1 class="logo">APEX CONSULT</h1>
      </a>
    ...
    <article>
      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <img src="desktop.png" width="61" height="61" alt="Vector Shape" class="shape shape-1">

          <img src="destination-5.jpg" width="56" height="74" alt="Vector Shape" class="shape shape-2">

          <img src="destination-3.jpg" width="57" height="72" alt="Vector Shape" class="shape shape-3">
          ...
          <ul class="destination-list">
            ...
            <li>
              <a href="#" class="destination-card">
                ...
                <figure class="card-banner">
                  <img src="hero-bg-bottom.png" width="1110" height="480" loading="lazy"
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="about-banner.png" width="740" height="518" loading="lazy"
                      alt="Kuala Lumpur, Malaysia" class="img-cover">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="author-avatar.png" width="740" height="518" loading="lazy"
  ...
  <footer class="footer" style="background-imagfooter-bg.png')">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2022 <a href="#" class="copyright-link">Apex Consult</a>. All Rights Reserved
        </p>
